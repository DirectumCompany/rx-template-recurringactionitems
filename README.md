...
На скриншоте ниже можно ознакомиться с примером настройки периодических поручений:
![recurringaction](https://github.com/DirectumCompany/rx-template-recurringactionitems/assets/71367764/674d06af-d631-48cf-8b83-8d31a8b614d0)
...
## Порядок установки
Для работы требуется установленный Directum RX версии 3.4 и выше (разработка для версии 3.3 в ветке "3.3"). 
