...
namespace DirRX.ActionItems
{
  ...
  partial class RepeatSettingSharedHandlers
  {
    ...
    public virtual void AssigneeChanged(DirRX.ActionItems.Shared.RepeatSettingAssigneeChangedEventArgs e)
    {
    ...
    {
      if ((e.NewValue == null || e.NewValue == 1) && _obj.Type.HasValue && _obj.Type.Value == DirRX.ActionItems.RepeatSetting.Type.Day)
        _obj.CreationDays = 0;
    ...
    public virtual void InitiatorChanged(DirRX.ActionItems.Shared.RepeatSettingInitiatorChangedEventArgs e)
    {
    ...
    public virtual void PriorityChanged(DirRX.ActionItems.Shared.RepeatSettingPriorityChangedEventArgs e)
    {
      if (e.NewValue != null && e.NewValue != e.OldValue)
      {
    ...
    public virtual void CategoryChanged(DirRX.ActionItems.Shared.RepeatSettingCategoryChangedEventArgs e)
    {
    ...
    public virtual void TypeChanged(Sungero.Domain.Shared.EnumerationPropertyChangedEventArgs e)
    {
      if (e.NewValue != e.OldValue)
      {
        ...
        {
          _obj.LabelType = DirRX.ActionItems.RepeatSettings.Resources.LabelYear;
        ...
        {
          _obj.LabelType = DirRX.ActionItems.RepeatSettings.Resources.LabelMonth;
        ...
        if (e.NewValue == ActionItems.RepeatSetting.Type.Day)
          _obj.LabelType = DirRX.ActionItems.RepeatSettings.Resources.LabelDay;
        
        if (e.NewValue == ActionItems.RepeatSetting.Type.Week)
          _obj.LabelType = DirRX.ActionItems.RepeatSettings.Resources.LabelWeek;
